...
namespace ITP1.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public IList<AuthenticationScheme> ExternalLogins { get; set; }//Ovo
        ...
        //Nije bilo async Task nego void
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    error.Description = error.Description.StartsWith("User name") && error.Description.EndsWith("already taken.") ? "Mail '"+Input.Email+"' je već zauzet." : error.Description;
